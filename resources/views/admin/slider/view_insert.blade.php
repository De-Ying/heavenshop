...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Thêm ảnh bìa')
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    ...
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="slider-form" action="{!! route('slider.process_insert') !!}" method="post" class="row" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <select class="select2 browser-default form-control" name="slider_type">
                                                            <option value="">Hãy chọn loại</option>
