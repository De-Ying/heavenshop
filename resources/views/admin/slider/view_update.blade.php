...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Cập nhật ảnh bìa')
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="mb-0 breadcrumbs">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('supplier.view_all') }}">Liệt kê ảnh bìa</a>
                                </li>
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    <div class="card-title">
                                        <div class="row">
                                            <div class="col s12 m6 l12">
                                                <h4 class="card-title">CẬP NHẬT ẢNH BÌA</h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="slider-form" action="{!! route('slider.process_update', ['slider_id' => $slider->slider_id]) !!}" method="post" class="row" enctype="multipart/form-data">
                                                @csrf

                                                <div class="col s12">
                                                    <div class="input-field col s12">
                                                        <label for="slider_name">Tên ảnh bìa</label>
                                                        <input id="slider_name" name="slider_name" type="text"
                                                            rules="required" class="form-control" value="{{ $slider->slider_name }}">
                                                        <span class="input-message"></span>
                                                    </div>

                                                    <div class="input-field col s12">
                                                        <label for="slider_description" class="fs-20 m-t-10 m-l-3">Mô tả ảnh bìa</label>
                                                        <textarea
                                                            style="resize: none"
                                                            rows="8"
                                                    ...
                                                    <div class="input-field col s12">
                                                        <select class="select2 browser-default form-control" name="slider_type">
                                                            @if($slider->slider_type == 1)
                                                                <option selected value="{{ $slider->slider_id }}">Slide</option>
                                                                <option value="2">Banner</option>
                                                            @elseif ($slider->slider_type == 2)
                                                                <option selected value="{{ $slider->slider_id }}">Banner</option>
                                                    ...
                                                    <div class="input-field col s12">
                                                        <img src="{{URL::to('public/uploads/slider/'.$slider->slider_image)}}" height="100" width="100" alt="{{ $slider->slider_name }}"/>
                                                    </div>
