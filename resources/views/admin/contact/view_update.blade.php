...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Cập nhật thông tin liên hệ')
                                    ...
                                    <div class="card-title">
                                        <div class="row">
                                            <div class="col s12 m6 l12">
                                                <h4 class="card-title">CẬP NHẬT THÔNG TIN LIÊN HỆ</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="contact-form" action="{!! route('contact.process_update', ['contact_id' => $contact->contact_id]) !!}" method="post" class="row">
                                                @csrf
                                                ...
                                                <div class="col s12">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input name="contact_address" type="text"
                                                            rules="required" class="form-control" value="{{ $contact->contact_address }}">
                                                    ...
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input name="contact_phone" type="text"
                                                            rules="required" class="form-control" value="{{ $contact->contact_phone }}">
                                                        <span class="input-message"></span>
                                                    </div>
                                                    ...
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input name="contact_email" type="text"
                                                            rules="required" class="form-control" value="{{ $contact->contact_email }}">
                                                        <span class="input-message"></span>
                                                    </div>
                                                    ...
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input name="contact_url_fanpage" type="text"
                                                            rules="required" class="form-control" value="{{ $contact->contact_url_fanpage }}">
                                                        <span class="input-message"></span>
                                                    </div>
