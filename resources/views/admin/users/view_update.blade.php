...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Cập nhật người dùng')
<style>
                        ...
                        <div class="card">
                            <div class="card-content">
                               <div class="card-body">
                                    ...
                                    <div class="row">
                                        <form id="users-form" action="{!! route('users.process_update', ['id' => $admin->id]) !!}" method="post" enctype="multipart/form-data">
                                            @csrf
                                                    ...
                                                    <div class="col s12 m6">
                                                        <div class="row">
                                                            ...
                                                            <div class="input-field col s12">
                                                                <select class="select2 browser-default form-control" name="status">
                                                                    <option value="1" {{ $admin->status == 1 ? 'selected' : '' }}>Hiển thị</option>
                                                            ...
                                                            <div class="col s12 input-field">
                                                                ...
                                                                <div class="m-t-10">
                                                                    <label>
                                                                        <input name="gender" type="radio" value="1" {{ $admin->gender == 1 ? 'checked' : '' }}>
                                                                        <span>Nam</span>
                                                                    </label>
                                                                    <label>
                                                                        <input name="gender" type="radio" value="0" {{ $admin->gender == 0 ? 'checked' : '' }}>
                                                                        <span>Nữ</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="input-field col s12">
                                                                @if ($admin->avatar != null)
                                                                    <img width="200px"
                                                                        ...
                                                                        src="{!! asset('public/uploads/avatar/' . $admin->avatar) !!}"
                                                                        alt="{{ $admin->user_name }}">
                                                                @else
                                                                    <img width="200px"
                                                                        height="200px"
