...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Cập nhật danh mục')
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="mb-0 breadcrumbs">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('category.view_all') }}">Liệt kê danh mục</a>
                                </li>
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    ...
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="category-form" action="{!! route('category.process_update', ['category_id' => $category->category_id]) !!}" method="post" class="row">
                                                @csrf
                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input  name="category_name" onkeyup="ChangeToSlug();" id="slug" type="text"
                                                            rules="required" class="form-control" value="{{ $category->category_name }}">
                                                        <span class="input-message"></span>
                                                    </div>

                                                    <div class="input-field col s12">
                                                        <label for="category_slug" id="label_slug" class="">Slug</label>
                                                        <input  name="category_slug" type="text" id="convert_slug"
                                                            rules="required" class="form-control" value="{{ $category->category_slug }}">
                                                        <span class="input-message"></span>
                                                    </div>

                                                    <div class="input-field col s12">
                                                        <select class="select2 browser-default form-control" rules="required" name="category_parent">
                                                            ...
                                                            @foreach ($categories as $cate)
                                                                ...
                                                                @if ($cate->category_parent == 0)
                                                                    <option
                                                                        {{ $cate->category_id == $category->category_id ? 'selected' : '' }}
                                                                ...
                                                                @foreach ($categories as $cate2)
                                                                    @if ($cate2->category_parent == $cate->category_id)
                                                                        <option
                                                                            {{ $cate2->category_id == $category->category_id ? 'selected' : '' }}
                                                                            value="{{ $cate2->category_id }}">
                                                                            -- {{ $cate2->category_name }}</option>
                                                                    @endif
                                                                @endforeach
