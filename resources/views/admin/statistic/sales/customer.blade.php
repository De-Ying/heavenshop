            ...
            <div class="col s12">
                <div class="container">
                        ...
                        <div class="card-panel">
                            <div class="row m-b-20 p-b-20">
                                <div class="col s12 m6 l2 display-flex align-items-center show-btn"
                                    style="width: 12.5%">
                                    <a href="{{ route('statistic.sales.timer') }}" class="btn btn-grd-default btn-sm m-r-5">
                                        Thời gian
                                    </a>
                                </div>
                            ...
                            <form action="{{ route('statistic.bill.pdf-bill') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col s12 m6 l4">
                                        ...
                                        <div class="input-field">
                                            <select class="select2 browser-default form-control listCustomer"
                                    ...
                                    <div class="col s12 m6 l4">
                                        ...
                                        <div class="input-field">
                                            <input type="text" name="customer_from" id="customer_from"
                                    ...
                                    <div class="col s12 m6 l4">
                                        ...
                                        <div class="input-field">
                                            <input type="text" name="customer_to" id="customer_to"
                                                class="form-control datepicker hide_input">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col s12 m6 l1 display-flex align-items-center show-btn m-t-20">
                                        <button type="button" name="customer-filter" id="customer-filter"
                        ...
                        <div class="row m-b-20">
                            <div class="col s12 m6 l4 display-flex align-items-center show-btn m-t-20">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <span class="sales_count counter"></span>
                            ...
                            <div class="col s12 m6 l4 display-flex align-items-center show-btn m-t-20">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <span class="funds_count counter"></span>
                            ...
                            <div class="col s12 m6 l4 display-flex align-items-center show-btn m-t-20">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <span class="profit_count counter"></span>
                    ...
                    <div class="row" style="padding: 0 15px;">
                        <button class="col s12 m6 l1 tablink m-t-5 btn" onclick="openPage('customerOverview', this, '#03a9f4')"
                    ...
                    <div id="customerOverview" class="tabcontent" style="margin: 0px -15px;">
                        ...
                        <div id="chartCustomer" style="height: 500px;"></div>
                    </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('.listCustomer').on('change', function() {
                var j = $(this).attr("id");
                var m = $(this).val();
                if (m === 'daily_report') {
                    $('#customer_from').val('');
    ...
    <script>
        am4core.ready(function() {
            ...
            var chart = am4core.create("chartCustomer", am4charts.XYChart);
            ...
            $('#customer-filter').click(function() {
                var customer_type = $('.listCustomer').val();
                var customer_from = $('#customer_from').val();
                var customer_to = $('#customer_to').val();
                var _token = $('input[name="_token"]').val();

                $.ajax({
                    url: '{{ route('statistic.sales.filter_by_date_customer') }}',
                    method: 'POST',
                    dataType: 'JSON',
                    data: {
                    ...
                    success: function(data) {
                        $('#chartCustomer').show();
                        chart.setData(data.customerStatistic);
                        document.getElementById('customer_from').innerHTML = customer_from;
                        document.getElementById('customer_to').innerHTML = customer_to;

                        $.each(data.customerStatistic, function(index, value) {
