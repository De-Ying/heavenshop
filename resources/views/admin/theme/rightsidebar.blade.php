                        ...
                        <ul class="p-0 mb-0 collection right-sidebar-chat">
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                ...
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-7.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-1.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                ...
                                <span class="avatar-status avatar-off avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-2.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-3.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-4.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                                    <h6 class="line-height-0">June Lane</h6>
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Ohh God
                                    </p>
                                </div>
                                <span class="secondary-content medium-small">4.14 AM</span>
                            </li>
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-off avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-5.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                                    <h6 class="line-height-0">Edward Fletcher</h6>
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Love you
                                    </p>
                                </div>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-6.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                                    <h6 class="line-height-0">Crystal Bates</h6>
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Can we
                                    </p>
                                </div>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                ...
                                <div class="user-content">
                                    ...
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Great!
                                    </p>
                                </div>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-off avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-8.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                ...
                                <div class="user-content">
                                    ...
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Got that
                                    </p>
                                </div>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-9.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-off avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-10.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                                    <h6 class="line-height-0">Sarah Graves</h6>
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Okay you
                                    </p>
                                </div>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-off avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-11.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                                    <h6 class="line-height-0">Andrew Hoffman</h6>
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Can do
                                    </p>
                                </div>
                            ...
                            <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                data-target="slide-out-chat">
                                <span class="avatar-status avatar-online avatar-50"><img
                                        src="{!! asset('public/backend/app-assets/images/avatar/avatar-12.png') !!}"
                                        alt="avatar">
                                    <i></i>
                                </span>
                                <div class="user-content">
                                    <h6 class="line-height-0">Camila Lynch</h6>
                                    <p class="pt-3 medium-small blue-grey-text text-lighten-3">Leave it
                                    </p>
                                </div>
                        ...
                        <ul class="mb-0 widget-timeline">
                            ...
                            <li class="timeline-items timeline-icon-red active">
                                ...
                                <div class="timeline-content">
                                    <img src="{!! asset('public/backend/app-assets/images/icon/pdf.png') !!}" alt="document"
