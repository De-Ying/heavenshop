...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Liệt kê sản phẩm')
                            ...
                            <div class="col s12">
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="inline-flex card-title m-b-20">
                                            <a href="{{ route('product.view_insert') }}"
                                                class="form-control btn btn-mat btn-info m-l-5"><i
                                                    class="fa fa-plus-square"></i> Thêm</a>
                                            <div class="m-l-5">
                                                <form action="{{ route('export_product_excel') }}" method="POST">
                                                    @csrf
                                                    <button type="submit"
                                                        class="form-control btn btn-success btn-mat">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($products as $product)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('review', ['product_id' => $product->product_id]) }}"
                                                                        class="block text-center">
                                                                        <i
