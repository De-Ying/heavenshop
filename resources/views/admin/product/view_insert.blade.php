...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Thêm sản phẩm')
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    ...
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="product-form" action="{!! route('product.process_insert') !!}" method="post" class="row" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="col s12">
                                                                ...
                                                                <option value="{{ $category->category_id }}">
                                                                    ...
                                                                    @else
                                                                        @foreach ($subcategory as $sub)
                                                                            @if ($sub->category_id == $category->category_parent)
                                                                                ({{ substr($sub->category_name, -4) }})
                                                                            @endif
                                                                        @endforeach
                                                                    @endif
                                                                </option>
                                                    ...
                                                    <div class="input-field col s12">
                                                        <select class="select2 browser-default form-control" name="product_brand">
                                                            <option value="">Hãy chọn thương hiệu</option>
