...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Thêm danh mục bài viết')
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="mb-0 breadcrumbs">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('category-post.view_category_post') }}">Liệt kê danh mục bài viết</a>
                                </li>
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    ...
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="category-post-form" action="{!! route('category-post.process_insert_category_post') !!}" method="post" class="row">
                                                @csrf
