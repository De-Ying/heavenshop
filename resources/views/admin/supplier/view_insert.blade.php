...
@section('title', 'Cửa hàng bán quần áo thời trang Heaven | Thêm nhà cung cấp')
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    ...
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <form id="supplier-form" action="{!! route('supplier.process_insert') !!}" method="post" class="row" enctype="multipart/form-data">
                                                @csrf
