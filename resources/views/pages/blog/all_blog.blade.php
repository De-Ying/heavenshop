                    ...
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        @foreach ($posts as $post)
                            <div class="p-b-63">
                                ...
                                <div class="p-t-32">
                                    <h4 class="p-b-15 blog_title">
                                        <a href="{{ route('blog_detail', ['post_slug' => $post->post_slug]) }}" class="cl2 hov-cl1 trans-04" style="font-family: Roboto,sans-serif; font-weight: bold;">
                                            {{ $post->post_title }}
                                        </a>
                                    </h4>

                                    <p class="stext-117 cl6 blog-desc">
                    ...
                    <div class="side-menu">
                        <div class="bor17 of-hidden pos-relative">
                            <form action="{{ route('blog_search') }}" method="GET">
                                <input class="stext-103 cl2 plh4 size-116 p-l-28 p-r-55" type="text" name="keyword" placeholder="Tìm kiếm">
