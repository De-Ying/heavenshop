                    ...
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        <div class="p-t-32">
                            <span class="flex-w flex-m stext-111 cl2 p-b-19">
                                ...
                                <span>
                                    {{ date('d', strtotime($post->post_date)) }}  {{ date('M', strtotime($post->post_date)) }}, {{ date('Y', strtotime($post->post_date)) }}
                                    <span class="cl12 m-l-4 m-r-6">|</span>
                                </span>
                                ...
                                @foreach ($related_post as $item)
                                    <li class="flex-w flex-t p-b-30">
                                        <a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                            <img src="{{ asset('public/uploads/blog/'.$item->post_image) }}" style="width: 90px; height: 65px"
                                                alt="PRODUCT">
                                        </a>
