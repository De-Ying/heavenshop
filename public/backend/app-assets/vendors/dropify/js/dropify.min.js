    ...
    function i(i, t) {
        if (
            ...
            var s = {
                ...
                messages: {
                    default: "Kéo và thả tệp vào đây khi nhấp chuột",
                ...
                error: {
                    ...
                    minWidth:
                        "Chiều rộng hình ảnh quá nhỏ (tối thiểu {{value}}} px).",
                    maxWidth:
                        "Chiều rộng hình ảnh quá lớn (tối đa {{value}}} px).",
                    minHeight:
                        "Chiều cao hình ảnh quá nhỏ (tối thiểu {{value}}} px).",
                    maxHeight:
                        "Chiều cao hình ảnh quá lớn (tối đa {{value}} px).",
                    imageFormat:
                        "Định dạng hình ảnh không được phép (chỉ {{value}}).",
                    fileExtension:
                        "Tệp không được phép (chỉ {{value}}).",
                },
                tpl: {
